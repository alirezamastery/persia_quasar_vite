...
import {
  ShopVariantSelectorTypeDetailResponse,
  ShopVariantSelectorValueResponse,
} from 'src/types/network/response/shop/selector'
...
const selectorType = ref<ShopVariantSelectorTypeDetailResponse | null>(null)
...
onMounted(async () => {
  ...
  try {
    const resType = await axiosInstance.get<ShopVariantSelectorTypeDetailResponse>(url)
...
function handleSelectorValueClick(selectorValue: ShopVariantSelectorValueResponse) {
